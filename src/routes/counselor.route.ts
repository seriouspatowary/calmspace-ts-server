...
import { getAllcounselor, updateInfo, toggleCounselorStatus, getCounselorById,editInfo, getUserForSidebar,postAvailability } from "../controllers/counselor.controller";
